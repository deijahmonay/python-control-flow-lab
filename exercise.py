...
def determine_season():
    ...
    month = input("Enter the current month (Jan - Dec): ").capitalize()
    day = input("Enter the current day: ")
    day_int = int(day)

    if month not in months:
        print("Invalid month. Please enter a valid month abbreviation such as Jan, Feb, Mar, etc.")
        return
    ...
    if month in ['Dec', 'Jan', 'Feb'] or (month == 'Mar' and day <= 19):
        ...
        season = 'Spring'
    elif month in ['Jun', 'Jul', 'Aug'] or (month == 'Sept' and day <= 21):
        season = 'Summer'
    else:
        season = 'Fall'
